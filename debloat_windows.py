...
def apply_registry_changes():
    ...
    try:
        registry_modifications = [
            ...
            (winreg.HKEY_CURRENT_USER, r"Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced", "HideFileExt", winreg.REG_DWORD, 0), # Show file extensions in Explorer
        ]
